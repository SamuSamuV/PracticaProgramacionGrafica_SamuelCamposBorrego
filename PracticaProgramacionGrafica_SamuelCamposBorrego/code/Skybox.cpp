...
namespace udit
{
    ...
    //SKYBOX INFINITO (Esto se ha implementado para que el punto 0,0 del skybox esté siempre en la camara)
    void Skybox::render(const Camera& camera)
    {
        ...
        // Obtenemos la matriz de vista pero la copiamos porque la vamos a modificar
        glm::mat4 model_view_matrix = camera.get_transform_matrix_inverse();

        model_view_matrix[3] = glm::vec4(0.f, 0.f, 0.f, 1.f);
